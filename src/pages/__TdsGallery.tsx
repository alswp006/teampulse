  ...
  return (
    <>
      ...
      <Section title="TextField (variants)">
        <TextField variant="box" label="Box" placeholder="Box variant" value={text} onChange={(e) => setText(e.target.value)} />
        <TextField variant="line" label="Line" placeholder="Line variant" value={text} onChange={(e) => setText(e.target.value)} />
        <TextField variant="big" label="Big" placeholder="Big variant" value={text} onChange={(e) => setText(e.target.value)} />
      </Section>
